    ...
    <footer className="bg-footer bg-cover bg-no-repeat pt-16 relative">
        ...
        <div className="container mx-auto z-20 relative">
         ...
         <ul className="flex text-white text-xl gap-4">
            <Link
            href="/"
            className="w-[54px] h-[54px] border border-white/[0.15] rounded-full
            flex items-center justify-center hover:text-accent transition-all">
                <FaYoutube />
            </Link>
            <Link
            href="/"
         ...
         {/* copyright */}
         <div className="border-t border-white/10 text-[15px] text-white/70
